...
src_prepare() {
	...
	epatch "${FILESDIR}"/38.0/1130175.patch
	epatch "${FILESDIR}"/38.0/sctp-36.patch
	epatch "${FILESDIR}"/38.0/1130710.patch

	# others
	epatch "${FILESDIR}"/38.0/basename.patch
	epatch "${FILESDIR}"/38.0/crashreporter.patch
	epatch "${FILESDIR}"/38.0/fts.patch
	epatch "${FILESDIR}"/38.0/libstagefright-cdefs.patch
	epatch "${FILESDIR}"/38.0/profiler-gettid.patch
	epatch "${FILESDIR}"/38.0/sandbox-cdefs.patch
	epatch "${FILESDIR}"/38.0/updater.patch
	epatch "${FILESDIR}"/38.0/xpcom-blocksize.patch
	epatch "${FILESDIR}"/38.0/sipcc.patch
