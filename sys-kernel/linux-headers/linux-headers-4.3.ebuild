...
src_prepare() {
	...
	# Fix for MUSL
	epatch "${FILESDIR}"/1-4-glibc-specific-inclusion-of-sysinfo.h-in-kernel.h.patch
	epatch "${FILESDIR}"/3-4-libc-compat.h-fix-some-issues-arising-from-in6.h.patch
	epatch "${FILESDIR}"/4-4-libc-compat.h-prevent-redefinition-of-struct-ethhdr.patch
}
